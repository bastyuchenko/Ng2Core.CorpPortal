        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vacancies_Projects_ProjectKey",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DirectMgrId = table.Column<int>(nullable: false),
                    Duration = table.Column<int>(nullable: false),
                    EmployeeId = table.Column<int>(nullable: false),
                    GroupLeadId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleAssignments_Employees_DirectMgrId",
                        column: x => x.DirectMgrId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoleAssignments_Employees_GroupLeadId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SkillVacancyId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillVacancies", x => x.SkillVacancyId);
                    table.ForeignKey(
                        name: "FK_SkillVacancies_Skills_SkillKey",
                        column: x => x.SkillKey,
                        principalTable: "Skills",
                        principalColumn: "SkillId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SkillVacancies_Vacancies_VacancyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleAssignments_DirectMgrId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleAssignments_GroupLeadId",
                table: "RoleAssignments",
                column: "GroupLeadId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillVacancies_SkillKey",
                table: "SkillVacancies",
                column: "SkillKey");

            migrationBuilder.CreateIndex(
                name: "IX_SkillVacancies_VacancyId",
                table: "SkillVacancies",
                column: "VacancyId");

            migrationBuilder.CreateIndex(
                name: "IX_Vacancies_ProjectKey",
                table: "Vacancies",
                column: "ProjectKey");
        }
